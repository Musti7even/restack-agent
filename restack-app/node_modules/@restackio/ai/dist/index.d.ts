...
import { SendAgentEvent, AgentEvent } from "./agent";
import { DataConverter } from "./security";
...
declare class Restack {
     ...
     */
    startService({ taskQueue, workflowsPath, agentsPath, functions, options, endpoints, dataConverter, }: ServiceInput): Promise<void>;
    /**
     ...
     */
    scheduleWorkflow({ workflowName, workflowId, input, taskQueue, schedule, event, isAgent, }: {
        workflowName: string;
        workflowId: string;
        input?: {
            [key: string]: any;
     ...
     */
    sendAgentEvent({ event, agent }: SendAgentEvent): Promise<unknown>;
    /**
     ...
     */
    scheduleAgent({ agentName, agentId, input, taskQueue, schedule, event, }: {
        agentName: string;
        agentId: string;
        input?: {
            [key: string]: any;
     ...
     */
    getAgentEvent({ agentId, runId, eventName, }: {
        agentId: string;
        runId?: string;
        eventName: string;
    }): Promise<WorkflowResultType<Workflow>>;
     ...
     */
    getAgentState({ agentId, runId, stateName, }: {
        agentId: string;
        runId?: string;
        stateName: string;
    }): Promise<WorkflowResultType<Workflow>>;
