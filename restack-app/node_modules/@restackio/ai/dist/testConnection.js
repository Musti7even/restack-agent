...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const workflowsPath = require.resolve("./playground");
            restack.startService({ workflowsPath }),
                console.log("Services running successfully.");
            const workflowRunId = yield restack.scheduleWorkflow({
                workflowName: "playgroundRun",
                workflowId: `playgroundRun-${Date.now()}`,
                input: {
                    functionName: "playgroundRun",
